    ...
    <div className="h-screen maxh-96 grid place-items-center">
      <div className="flex-col flex p-8 lg:w-4/6 w-5/6">
        ...
        <span className="text-xl w-4/5 md:text-xl text-lg">
         I'm a developer focused on building user experiences through design, innovation, and a lot of code. Currently, I am building onboarding solutions for customers at <a href="https://www.stripe.com" className="text-t-green font-semibold hover:underline">Stripe</a>.
        </span>
